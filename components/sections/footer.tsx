        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-6 border-t border-border/50">
            <div className="flex flex-wrap items-center justify-center gap-6">
              <span className="font-mono text-sm text-foreground/80 font-medium">{t.footer.contactUs}:</span>
              ...
              <a href="https://t.me/k0jihero" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-foreground/60 hover:text-foreground transition-colors">
                <Send className="w-4 h-4" />
                <span className="font-mono text-sm">{t.footer.telegram}</span>
              </a>
            </div>
